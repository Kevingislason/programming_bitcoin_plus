...
//     //U256::from_big_endian is going to fuck me over is the tx isn't precisely the right length
//     //I should write a test case for this
...
fn main() {
  let phrase = Phrase::new(String::from("abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about"));
  let entropy = phrase.to_entropy().unwrap();
  //let seed = entropy_to_seed(entropy.clone(), "TREZOR");
  println!("{}", hex::encode(entropy));

  let seed = Seed::new(&phrase, &"TREZOR");
  println!("{}", hex::encode(seed.as_bytes()));
}

//ME
//b43c67f1b354a8c17e73d8b483f349f3a3549a4ee730ef08fbbd577d4decf06438b306ff1196096a03f77e2efe70302078841a3b100ef27805b1728d52a7b4e9
